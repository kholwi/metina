    ...
    <header className="w-full bg-gray-800 text-gray-100 body-font mb-4 shadow-sm">
      ...
      <div className="container mx-auto flex justify-between items-center py-7 px-5">
        ...
        <a href="#link" className="flex flex-shrink-0 title-font font-medium items-center text-gray-900 md:mb-0">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-white p-2 bg-gradient-to-br from-yellow-500 to-red-500 rounded-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
          </svg>
          <span className="ml-3 text-xl text-gray-100 font-semibold antialiased">Metina</span>
        </a>
        {/* ::Navbar */}
        <nav className="hidden md:mr-auto md:ml-4 md:pl-4 md:border-l md:border-gray-500 md:flex flex-wrap items-center justify-center text-base tracking-wide">
          <a href="#link" className="mr-8 hover:text-yellow-300">Solutions</a>
          <a href="#link" className="mr-8 hover:text-yellow-300">Prices</a>
          <a href="#link" className="mr-8 hover:text-yellow-300">About</a>
          <a href="#link" className="mr-8 hover:text-yellow-300">Contact</a>
        </nav>
        {/* ::Avatar */}
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 rounded-md text-gray-300 bg-gradient-to-br from-transparent to-transparent hover:text-white hover:from-yellow-500 hover:to-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
